                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="type_doc" class="col-md-4 col-form-label text-md-right">Tipo de documento *</label>

                            <div class="col-md-6">
                                <select id="type_doc" class="form-control{{ $errors->has('type_doc') ? ' is-invalid' : '' }}" name="type_doc" value="{{ old('type_doc') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            <label for="doc" class="col-md-4 col-form-label text-md-right">Documento *</label>

                            <div class="col-md-6">
                                <input id="doc" type="text" class="form-control{{ $errors->has('doc') ? ' is-invalid' : '' }}" name="doc" value="{{ old('doc') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">Correo electronicó *</label>
                        ...
                        <div class="form-group row">
                            <label for="mobile" class="col-md-4 col-form-label text-md-right">Celular *</label>
