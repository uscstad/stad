  ...
  <div class="container containerx">
    <div class="card">
      <div class="card-header">
        <div class="col-md-12">
          <i class="fas fa-users"></i> <b>Lista de Usuarios</b>
        </div>
      </div>
      <div class="card-body">
        <div class="col-sm-12">
          <div class="row">
            <div class="col-12 col-sm-6">
              <div class="form-group">
                <input type="text" class="form-control" v-model="search" placeholder="Buscar Usuarios" />
              </div>
            </div>
            <div class="col-12 col-sm-6 text-right">
              <a href="./" class="btn btn-primary"><i class="fas fa-chevron-circle-left fa-lg"></i> Atras</a>  
              <a href="#" class="btn btn-primary" @click="showCreate=true"><i class="fas fa-plus-circle fa-lg"></i> Usuario</a>
            </div>
          </div>
        </div>
            ...
            <table class="table table-striped table-bordered">
              ...
              <tbody>
                <tr v-for="(value, index) in searchAll">
                  ...
                  <td>{{ value.type_doc | capitalize }} - {{ value.doc }}</td>
                  <td>{{ value.name }} {{ value.lastname }}</td>
                  <td>
                    <p>Usuario: <b>{{ value.user }}</b></p>
                    <p>Dirección: <b>{{ value.address }}</b></p>
                    <p>Celular: <b>{{ value.mobile }}</b></p>
                    <p>Telefono: <b>{{ value.phone }}</b></p>
                  </td>  
                  <td scope="col">
                    <toggle-button 
        ...
        <div class="col-md-12" v-else>
          <h4>No se han encontrado registros de Usuarios.</h4>
        </div>
      </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title"><i class="fas fa-users"></i> <b>Creación de Usuarios</b></h4>
        ...
        <div class="modal-mask">
          <div class="modal-wrapper">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title"><i class="fas fa-users"></i> <b>Editar Usuario</b></h4>
                  <button type="button" class="close" @click="cancel">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
        ...
        <div class="modal-mask">
          <div class="modal-wrapper">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title"><i class="fas fa-users"></i> <b>Eliminar Usuario</b></h4>
                  <button type="button" class="close" @click="cancel">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  <h4 class="text-center">¿Esta seguro de que desea eliminar a <strong>{{find.name}}</strong> de los Usuarios?</h4>
                </div>
                <div class="modal-footer">
  ...
  export default { 
    data(){ 
      return { 
        ...
        type: '',
        status: 1,
        find: {'id': '', 'name': '', 'lastname': '', 'status': 1},
        errors: [],
        pagination: {
          'prev_page_url':'',
          'next_page_url':'',
    ...
    methods: {
      ...
      fetchStories(page_url) {
        ...
        axios.get(page_url).then(function (response) {
          vm.searchData = response.data.users.data;
          vm.pagination = response.data.pagination;
        });
      },
      getStatus(value){
        var url = 'users/getstatus/' + value.id;
